...
class _AdminMenuState extends State<AdminMenu> {
  ...
  void initState() {
    itemList=[
      ...
      MenuCard(icon: Icons.category, title: "Projects", function: (){
      ...
      MenuCard(icon: Icons.people_alt_outlined, title: "Clients", function: (){
        Navigator.pushNamed(context, customers);
      }),
        ...
        child: GridView.builder(
          scrollDirection: Axis.vertical,
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisSpacing: 10,
                crossAxisSpacing: 10,
                childAspectRatio: MediaQuery.of(context).size.width * 0.4 / 100),
